...
public class User implements UserDetails {
    ...
    @Column(name = "age")
    @NotEmpty(message = "Укажите возраст")
    private String age;
    ...
    public User(String username, String password, Collection<? extends org.springframework.security.core.GrantedAuthority> authorities) {
